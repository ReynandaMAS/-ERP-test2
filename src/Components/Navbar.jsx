      ...
      <div className="relative">
        <div className="flex justify-between m-1 md:m-10 text-3xl font-extrabold">
          <div className="flex gap-5 items-center">
            ...
            <div className="text-white">RYN</div>
          </div>
          <div className="flex items-center md:hidden">
            {open ? (
              <IoClose onClick={() => setOpen(!open)} size={40} />
            ) : (
              <IoMenu onClick={() => setOpen(!open)} size={40} />
            )}
          </div>
          <ul className="md:flex md:items-center gap-12 hidden">
            ...
            <li>
              <button
                ...
                className="border-2 border-[#6fe1ff] rounded-lg text-[#6fe1ff] text-lg font-bold py-2 px-16 hover:bg-[#6fe1ff] hover:text-white"
              >
                LOGIN
              </button>
            </li>
        ...
        {/* menu-burger */}
        <div
          className={`bg-[#f3f4f6] absolute w-full md:hidden ${
            open ? "" : "hidden"
          }`}
        >
          <ul className="flex flex-col gap-4 text-center">
            ...
            <li>
              <button
                onClick={() => props.func(true)}
                className="cursor-pointer hover:text-[#6fe1ff]"
              >
                LOGIN
              </button>
            </li>
